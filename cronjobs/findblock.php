...
//	  if($aBlock['height'] % 100000== 88888)
//	  {
//		  $log->logError(' '.floor($aBlock['height']/100000).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus 100');
//		  $transaction->addTransaction($iAccountId,$aBlock['amount']*0.01*0.2*100000 , 'Bonus', $aBlock['id']);
//	  }
//	  else  if($aBlock['height'] % 10000 == 8888)
//	  {
//		  $log->logError(' '.floor($aBlock['height']/10000).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus 100');
//		  $transaction->addTransaction($iAccountId,$aBlock['amount']*0.01*0.2*10000 , 'Bonus', $aBlock['id']);
//	  }
//	  else  if($aBlock['height'] % 1000 ==888)
//	  {
//		  $log->logError(' '.floor($aBlock['height']/1000).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus 100');
//		  $transaction->addTransaction($iAccountId,$aBlock['amount']*0.01*0.2*1000, 'Bonus', $aBlock['id']);
//	  }
//	   else if($aBlock['height'] % 100 == 88)
//	  {
//		  $log->logError(' '.floor($aBlock['height']/100).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus 100');
//	      $transaction->addTransaction($iAccountId, $aBlock['amount']*0.01*0.2*100, 'Bonus', $aBlock['id']);
//	  } 
//      else if($aBlock['height'] % 10 == 8)
//	  {
//		  $log->logError(' '.floor($aBlock['height']/10).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus 100');
//		  $transaction->addTransaction($iAccountId,$aBlock['amount']*0.01*0.2*10, 'Bonus', $aBlock['id']);
//	  }
//	  else
//	  {
//		 // $transaction->addTransaction($iAccountId, 1, 'Bonus', $aBlock['id']);
//		 // $log->logError(' '.floor($aBlock['height']/10).' '.($aBlock['height'] % floor($aBlock['height']/10)).' bonus for block id '.$iAccountId.'height'.$aBlock['height'].' bonus null');
//	  }
