 ...
 *   name     =  'mpos'
 **/
$config['db']['host'] = 'rdsu2ayez6j6rfe.mysql.rds.aliyuncs.com';
$config['db']['user'] = 'capslock1874';
$config['db']['pass'] = 'a1235813';
$config['db']['port'] = 3306;
$config['db']['name'] = 'quarkbardb';
...
$config['wallet']['host'] = 'localhost:7655';
$config['wallet']['username'] = 'travelcoinrpc';
$config['wallet']['password'] = 'travelcoinpass';
 ...
 *
 **/
$config['gettingstarted']['coinname'] = 'quarkbarcoin';
$config['gettingstarted']['coinurl'] = 'http://www.litecoin.org';
$config['gettingstarted']['stratumport'] = '1145';
